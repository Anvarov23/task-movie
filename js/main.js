...
function movieTime(array, node) {
    ...
    for (cinema of array) {
        ...
        newId.textContent = "ID: " + cinema.id;
        newTitle.textContent = cinema.title;
        newImg.src = cinema.poster;
        newInfo.textContent = "Overview: " + cinema.overview;
        newDate.textContent = "Release date: " + cinema.release_date;
        newGenres.textContent = "Gernes: " + cinema.genres;
        ...
        newId.setAttribute("class", "id" )
        newGenres.setAttribute("class", "genres")
    }
}

var elSelect = document.querySelector(".select-genres");
let result = [];
...
var elSelect2 = document.querySelector(".select-order");
let result2 = [];
